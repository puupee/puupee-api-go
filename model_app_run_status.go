...
// checks if the AppRunStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppRunStatus{}

// AppRunStatus struct for AppRunStatus
...
func (o AppRunStatus) MarshalJSON() ([]byte, error) {
...
func (o AppRunStatus) ToMap() (map[string]interface{}, error) {
