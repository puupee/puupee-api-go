...
`func (o *CreateUpdateItemDto) GetSize() int32`

GetSize returns the Size field if non-nil, zero value otherwise.

### GetSizeOk

`func (o *CreateUpdateItemDto) GetSizeOk() (*int32, bool)`
...
`func (o *CreateUpdateItemDto) SetSize(v int32)`

SetSize sets Size field to given value.

### HasSize

`func (o *CreateUpdateItemDto) HasSize() bool`
