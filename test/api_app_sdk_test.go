...
func Test_puupee_AppSdkApiService(t *testing.T) {
    ...
    t.Run("Test AppSdkApiService ApiAppAppSdkIdDelete", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.AppSdkApi.ApiAppAppSdkIdDelete(context.Background(), id).Execute()
    ...
    t.Run("Test AppSdkApiService ApiAppAppSdkPut", func(t *testing.T) {

        t.Skip("skip test")  // remove to run test

        resp, httpRes, err := apiClient.AppSdkApi.ApiAppAppSdkPut(context.Background()).Execute()
