...
func (r ApiGetAbpApplicationConfigurationRequest) IncludeLocalizationResources(includeLocalizationResources bool) ApiGetAbpApplicationConfigurationRequest {
	r.includeLocalizationResources = &includeLocalizationResources
	return r
}

func (r ApiGetAbpApplicationConfigurationRequest) Execute() (*ApplicationConfigurationDto, *http.Response, error) {
	return r.ApiService.GetAbpApplicationConfigurationExecute(r)
}
