...
func (o *EmailSettingsDto) GetSmtpUserName() string {
	if o == nil || o.SmtpUserName.Get() == nil {
		var ret string
		return ret
	}
...
func (o *EmailSettingsDto) GetSmtpUseDefaultCredentials() bool {
	if o == nil || o.SmtpUseDefaultCredentials == nil {
		var ret bool
		return ret
	}
...
func (o *EmailSettingsDto) GetDefaultFromAddress() string {
	if o == nil || o.DefaultFromAddress.Get() == nil {
		var ret string
		return ret
	}
...
func (o *EmailSettingsDto) GetDefaultFromDisplayName() string {
	if o == nil || o.DefaultFromDisplayName.Get() == nil {
		var ret string
		return ret
	}
...
func (o EmailSettingsDto) MarshalJSON() ([]byte, error) {
	...
	if o.SmtpEnableSsl != nil {
		toSerialize["smtpEnableSsl"] = o.SmtpEnableSsl
	}
	if o.SmtpUseDefaultCredentials != nil {
