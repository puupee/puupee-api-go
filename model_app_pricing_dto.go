...
type AppPricingDto struct {
	...
	// 收费点
	Items []AppPricingItemValueDto `json:"items,omitempty"`
}
...
// SetNaming gets a reference to the given AppPriceNaming and assigns it to the Naming field.
...
func (o *AppPricingDto) GetItems() []AppPricingItemValueDto {
	if o == nil || IsNil(o.Items) {
		var ret []AppPricingItemValueDto
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []AppPricingItemValueDto and assigns it to the Items field.
