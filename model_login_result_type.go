...
type LoginResultType int32

// List of LoginResultType
const (
	LOGINRESULTTYPE__1 LoginResultType = 1
	LOGINRESULTTYPE__2 LoginResultType = 2
	LOGINRESULTTYPE__3 LoginResultType = 3
	LOGINRESULTTYPE__4 LoginResultType = 4
	LOGINRESULTTYPE__5 LoginResultType = 5
)
...
func NewLoginResultTypeFromValue(v int32) (*LoginResultType, error) {
