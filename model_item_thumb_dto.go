...
// ItemThumbDto struct for ItemThumbDto
type ItemThumbDto struct {
	...
	ThumbItem *ItemDto `json:"thumbItem,omitempty"`
}
...
func (o *ItemThumbDto) SetCreatorIdNil() {
	o.CreatorId.Set(nil)
}
...
func (o *ItemThumbDto) SetLastModificationTimeNil() {
...
func (o *ItemThumbDto) SetLastModifierIdNil() {
...
func (o *ItemThumbDto) SetDeleterIdNil() {
	o.DeleterId.Set(nil)
}
...
func (o *ItemThumbDto) SetDeletionTimeNil() {
...
// SetThumbItem gets a reference to the given ItemDto and assigns it to the ThumbItem field.
func (o *ItemThumbDto) SetThumbItem(v ItemDto) {
	o.ThumbItem = &v
}

func (o ItemThumbDto) MarshalJSON() ([]byte, error) {
...
type NullableItemThumbDto struct {
	value *ItemThumbDto
	isSet bool
}

func (v NullableItemThumbDto) Get() *ItemThumbDto {
	return v.value
}

func (v *NullableItemThumbDto) Set(val *ItemThumbDto) {
	v.value = val
	v.isSet = true
}

func (v NullableItemThumbDto) IsSet() bool {
	return v.isSet
}

func (v *NullableItemThumbDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemThumbDto(val *ItemThumbDto) *NullableItemThumbDto {
	return &NullableItemThumbDto{value: val, isSet: true}
}

func (v NullableItemThumbDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemThumbDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
