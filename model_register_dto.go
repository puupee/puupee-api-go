...
func (o *RegisterDto) UnmarshalJSON(data []byte) (err error) {
	...
	varRegisterDto := _RegisterDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegisterDto)

	if err != nil {
		return err
	}

	*o = RegisterDto(varRegisterDto)
