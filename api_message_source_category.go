...
func (r ApiGetMessageSourceCategoryListRequest) Execute() ([]MessageSourceCategoryDto, *http.Response, error) {
	return r.ApiService.GetMessageSourceCategoryListExecute(r)
}
