...
func (o *AppRunRecordUpdateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRunRecordUpdateDto := _AppRunRecordUpdateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppRunRecordUpdateDto)

	if err != nil {
		return err
	}

	*o = AppRunRecordUpdateDto(varAppRunRecordUpdateDto)
