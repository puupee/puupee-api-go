...
func (r ApiCreateRequest) Body(body CreateAvatarDto) ApiCreateRequest {
	r.body = &body
	return r
}

func (r ApiCreateRequest) Execute() (*AvatarDto, *http.Response, error) {
...
*/
func (a *AvatarApiService) Create(ctx context.Context) ApiCreateRequest {
	return ApiCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return AvatarDto
func (a *AvatarApiService) CreateExecute(r ApiCreateRequest) (*AvatarDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AvatarApiService.Create")
	if err != nil {
