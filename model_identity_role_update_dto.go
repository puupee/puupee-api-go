...
func (o *IdentityRoleUpdateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityRoleUpdateDto := _IdentityRoleUpdateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIdentityRoleUpdateDto)

	if err != nil {
		return err
	}

	*o = IdentityRoleUpdateDto(varIdentityRoleUpdateDto)
