...
func (r ApiCreateAppUserScoreRequest) Body(body CreateOrUpdateAppUserScoreDto) ApiCreateAppUserScoreRequest {
	r.body = &body
	return r
}

func (r ApiCreateAppUserScoreRequest) Execute() (*AppUserScoreDto, *http.Response, error) {
	return r.ApiService.CreateAppUserScoreExecute(r)
}
