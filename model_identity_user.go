...
func (o IdentityUser) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NormalizedEmail) {
		toSerialize["normalizedEmail"] = o.NormalizedEmail
	}
	...
	if !IsNil(o.SecurityStamp) {
		toSerialize["securityStamp"] = o.SecurityStamp
	}
	...
	if !IsNil(o.ShouldChangePasswordOnNextLogin) {
		toSerialize["shouldChangePasswordOnNextLogin"] = o.ShouldChangePasswordOnNextLogin
	}
