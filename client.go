...
// APIClient manages communication with the Puupee API API v1.0.0.0
...
type APIClient struct {
	...
	UserStorageApi *UserStorageApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PuupeeApi = (*PuupeeApiService)(&c.common)
