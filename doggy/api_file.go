...
func (r ApiApiAppFileFileOrCredentialsGetRequest) Key(key string) ApiApiAppFileFileOrCredentialsGetRequest {
	r.key = &key
	return r
}
...
type ApiApiAppFileUrlPostRequest struct {
	ctx _context.Context
	ApiService *FileApiService
	key *string
}

func (r ApiApiAppFileUrlPostRequest) Key(key string) ApiApiAppFileUrlPostRequest {
	r.key = &key
	return r
}

func (r ApiApiAppFileUrlPostRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.ApiAppFileUrlPostExecute(r)
}

/*
ApiAppFileUrlPost Method for ApiAppFileUrlPost

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiAppFileUrlPostRequest
*/
func (a *FileApiService) ApiAppFileUrlPost(ctx _context.Context) ApiApiAppFileUrlPostRequest {
	return ApiApiAppFileUrlPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *FileApiService) ApiAppFileUrlPostExecute(r ApiApiAppFileUrlPostRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FileApiService.ApiAppFileUrlPost")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/app/file/url"
