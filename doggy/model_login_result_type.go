...
const (
	SUCCESS LoginResultType = "Success"
	INVALID_USER_NAME_OR_PASSWORD LoginResultType = "InvalidUserNameOrPassword"
	NOT_ALLOWED LoginResultType = "NotAllowed"
	LOCKED_OUT LoginResultType = "LockedOut"
	REQUIRES_TWO_FACTOR LoginResultType = "RequiresTwoFactor"
)
