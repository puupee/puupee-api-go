...
func (o *DateTimeFormatDto) GetCalendarAlgorithmType() string {
	if o == nil || o.CalendarAlgorithmType.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DateTimeFormatDto) GetDateTimeFormatLong() string {
	if o == nil || o.DateTimeFormatLong.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DateTimeFormatDto) GetShortDatePattern() string {
	if o == nil || o.ShortDatePattern.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DateTimeFormatDto) GetFullDateTimePattern() string {
	if o == nil || o.FullDateTimePattern.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DateTimeFormatDto) GetDateSeparator() string {
	if o == nil || o.DateSeparator.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DateTimeFormatDto) GetShortTimePattern() string {
	if o == nil || o.ShortTimePattern.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DateTimeFormatDto) GetLongTimePattern() string {
	if o == nil || o.LongTimePattern.Get() == nil {
		var ret string
		return ret
	}
