...
// checks if the DateTimeKeyValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DateTimeKeyValue{}
...
func (o *DateTimeKeyValue) SetDurationSecondsNil() {
...
func (o *DateTimeKeyValue) SetExpiredAtNil() {
	o.ExpiredAt.Set(nil)
}
...
func (o *DateTimeKeyValue) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o DateTimeKeyValue) ToMap() (map[string]interface{}, error) {
