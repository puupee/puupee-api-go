...
func (o *UpdateEmailSettingsDto) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateEmailSettingsDto := _UpdateEmailSettingsDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateEmailSettingsDto)

	if err != nil {
		return err
	}

	*o = UpdateEmailSettingsDto(varUpdateEmailSettingsDto)
