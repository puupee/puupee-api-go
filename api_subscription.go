...
func (r ApiGetByIdRequest) AppId(appId string) ApiGetByIdRequest {
	r.appId = &appId
	return r
}

func (r ApiGetByIdRequest) Execute() (*SubscriptionDto, *http.Response, error) {
...
*/
func (a *SubscriptionApiService) GetById(ctx context.Context) ApiGetByIdRequest {
	return ApiGetByIdRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubscriptionApiService) GetByIdExecute(r ApiGetByIdRequest) (*SubscriptionDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionApiService.GetById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
