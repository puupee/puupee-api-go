...
type _SendPasswordResetCodeDto SendPasswordResetCodeDto
...
func (o *SendPasswordResetCodeDto) UnmarshalJSON(data []byte) (err error) {
	...
	varSendPasswordResetCodeDto := _SendPasswordResetCodeDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendPasswordResetCodeDto)

	if err != nil {
		return err
	}

	*o = SendPasswordResetCodeDto(varSendPasswordResetCodeDto)
