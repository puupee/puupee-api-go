...
type ItemDto struct {
	...
	Thumb *ItemThumbDto `json:"thumb,omitempty"`
...
func (o *ItemDto) SetParentItemIdNil() {
...
// SetThumb gets a reference to the given ItemThumbDto and assigns it to the Thumb field.
...
// SetChildren gets a reference to the given []ItemDto and assigns it to the Children field.
