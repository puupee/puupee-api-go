...
func (o *IdentityUserCreateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varIdentityUserCreateDto := _IdentityUserCreateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIdentityUserCreateDto)

	if err != nil {
		return err
	}

	*o = IdentityUserCreateDto(varIdentityUserCreateDto)
