...
func (r ApiBarkRequest) Level(level string) ApiBarkRequest {
	r.level = &level
	return r
}
...
func (r ApiGetNotificationListRequest) Sorting(sorting string) ApiGetNotificationListRequest {
	r.sorting = &sorting
	return r
}

func (r ApiGetNotificationListRequest) SkipCount(skipCount int32) ApiGetNotificationListRequest {
	r.skipCount = &skipCount
	return r
}

func (r ApiGetNotificationListRequest) MaxResultCount(maxResultCount int32) ApiGetNotificationListRequest {
	r.maxResultCount = &maxResultCount
	return r
}

func (r ApiGetNotificationListRequest) Execute() (*NotificationInfoDtoPagedResultDto, *http.Response, error) {
