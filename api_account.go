...
func (r ApiChangePasswordRequest) Body(body ChangePasswordDto) ApiChangePasswordRequest {
	r.body = &body
	return r
}
...
func (r ApiGetRequest) Execute() (*UserProfileDto, *http.Response, error) {
...
*/
func (a *AccountApiService) Get(ctx context.Context) ApiGetRequest {
	return ApiGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccountApiService) GetExecute(r ApiGetRequest) (*UserProfileDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountApiService.Get")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
