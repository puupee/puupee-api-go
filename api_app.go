...
type ApiApiAppAppIdRunStatePutRequest struct {
	ctx context.Context
	ApiService *AppApiService
	id string
...
func (r ApiApiAppAppIdRunStatePutRequest) Execute() (*AppRunRecordDto, *http.Response, error) {
	return r.ApiService.ApiAppAppIdRunStatePutExecute(r)
}

/*
ApiAppAppIdRunStatePut Method for ApiAppAppIdRunStatePut

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiApiAppAppIdRunStatePutRequest
*/
func (a *AppApiService) ApiAppAppIdRunStatePut(ctx context.Context, id string) ApiApiAppAppIdRunStatePutRequest {
	return ApiApiAppAppIdRunStatePutRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *AppApiService) ApiAppAppIdRunStatePutExecute(r ApiApiAppAppIdRunStatePutRequest) (*AppRunRecordDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppApiService.ApiAppAppIdRunStatePut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiApiAppAppRunPostRequest) Execute() (*AppRunRecordDto, *http.Response, error) {
	return r.ApiService.ApiAppAppRunPostExecute(r)
}

/*
ApiAppAppRunPost Method for ApiAppAppRunPost

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiAppAppRunPostRequest
*/
func (a *AppApiService) ApiAppAppRunPost(ctx context.Context) ApiApiAppAppRunPostRequest {
	return ApiApiAppAppRunPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AppRunRecordDto
func (a *AppApiService) ApiAppAppRunPostExecute(r ApiApiAppAppRunPostRequest) (*AppRunRecordDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppApiService.ApiAppAppRunPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
